...
return [
    ...
    'modal' => [
        ...
        'delete' => [
            'title' => 'حذف المدفوعة',
            'title_multiple' => 'حذف المدفوعات',
            'select-option' => 'إختر نوع الحذف: ',
            'soft-delete' => 'حذف جزئي',
            'permanent-delete' => 'حذف نهائي',
            'content' => 'هل أنت متأكد أنك تريد حذف اشتراك الخطة: :name للمعلن: :advertiser؟',
            'content_multiple' => 'هل أنت متأكد أنك تريد حذف هذه المدفوعات؟',
            'submit' => 'حذف',
            'cancel' => 'إلغاء',
        ],
        'restore' => [

...
return [
    ...
    'content' => [
        'status' => [
            ...
            'key_fingerprint' => 'بصمة المفتاح الخاص',
            'key_fingerprint_hint' => 'قارن هذه البصمة بين السيرفر والجهاز المحلي: اختلافها يعني أن نص المفتاح تغيّر أثناء النسخ (ناقص أو مشوّه).',
            'key_usable' => 'صلاحية المفتاح للتوقيع',
            'key_usable_yes' => 'صالح — يستطيع التوقيع',
            'key_usable_no' => 'تالف — لا يستطيع التوقيع',
            'server_time' => 'وقت السيرفر',
            'server_time_hint' => 'إن اختلف عن الوقت الحقيقي بأكثر من بضع دقائق، سيرفض Google الطلبات بخطأ invalid_grant.',

@props(['cities'=>null])
<div class="form-group row" x-data="{city_id: @entangle('city_id').defer, country_cities: {{$cities}},}"
     x-subscribe="country_cities"
    ...
    <div class="col-lg-10">
        <select x-cloak x-model="city_id" name="city_id"
            ...
            <template x-for="[id, value] in Object.entries(country_cities)">

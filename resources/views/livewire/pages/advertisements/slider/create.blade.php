<div class="card-body">
    <form wire:submit.prevent="store" enctype="multipart/form-data">
        <div class="form-group row">
            <label class="col-form-label col-lg-1" for="advertisement_url">{{__('pages/advertisements/slider/create.content.inputs.url')}}</label>
            <div class="col-lg-11">
        ...
        <div class="form-group row"
            ...
            <label for="image"
                   class="col-form-label col-lg-1">{{__('pages/advertisements/slider/create.content.inputs.image')}}</label>
            <div class="col-lg-11">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-1"
                   for="starts_at">{{__('pages/advertisements/slider/create.content.inputs.starts_at')}}</label>
            <div class="col-lg-11">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-1"
                   for="ends_at">{{__('pages/advertisements/slider/create.content.inputs.ends_at')}}</label>
            <div class="col-lg-11">
        ...
        <div class="text-right">
            <x-primary-button type="submit">
                {{__('pages/advertisements/slider/create.content.submit')}}
            </x-primary-button>
        </div>
    </form>
</div>

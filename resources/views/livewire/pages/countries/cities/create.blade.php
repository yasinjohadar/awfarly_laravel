    ...
    <form wire:submit.prevent="store">
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="country_code">{{__('pages/countries/cities/create.content.inputs.country_code')}}</label>
            <div class="col-lg-10">
                <select class="form-control @error('country_code') is-invalid @enderror" wire:model.defer="country_code" id="country_code">
                    <option value="none">{{__('pages/countries/cities/create.content.inputs.placeholders.select_code')}}</option>

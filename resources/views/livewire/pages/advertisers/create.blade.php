    ...
    <form wire:submit.prevent="store">
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="name">{{__('pages/advertisers/create.content.inputs.name')}}</label>
            <div class="col-lg-10">
        ...
        <div class="form-group row" wire:ignore
             ...
             x-init="$nextTick(() => {
             select2 = $($refs.business_type).select2({
                    placeholder: '{{__('pages/advertisers/create.content.inputs.placeholders.business_type')}}',
                    cache: true
                }).val('').change();
            ...
            <label class="col-form-label col-lg-2"
                   for="business_type">{{__('pages/advertisers/create.content.inputs.business_type')}}</label>
            <div class="col-lg-10">
                <select x-cloak wire:model.defer="business_type" x-ref="business_type"
                        x-model="business_type"
                        data-placeholder="{{__('pages/advertisers/create.content.inputs.placeholders.business_type')}}"
                        x-bind:value="business_type"
                        class="form-control @error('business_type') is-invalid @enderror" id="business_type">
                    @foreach ($business_types as $index=> $business_type)
                        <option value="{{$index}}">{{$business_type}}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="email">{{__('pages/advertisers/create.content.inputs.email')}}</label>
            <div class="col-lg-10">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="mobile">{{__('pages/advertisers/create.content.inputs.mobile')}}</label>
            <div class="col-lg-10">
                <input dir="ltr" type="text" class="form-control{{app()->getLocale() === 'ar' ? ' text-left' : ''}} @error('mobile') is-invalid @enderror" id="mobile"
        ...
        <div class="form-group row"
            ...
            <label for="image"
                   class="col-form-label col-lg-2">{{__('pages/advertisers/create.content.inputs.placeholders.choose_file')}}</label>
            <div class="col-lg-10">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="username">{{__('pages/advertisers/create.content.inputs.username')}}</label>
            <div class="col-lg-10">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="password">{{__('pages/advertisers/create.content.inputs.password')}}</label>
            <div class="col-lg-10">
        ...
        <div class="form-group row" wire:ignore
             ...
             x-init="$nextTick(() => {
                 select2 = $($refs.country_code).select2({
                        placeholder: '{{__('pages/advertisers/create.content.inputs.placeholders.country')}}',
                        cache: true
                    }).val('').change();
                    select2.on('change', (event) => {
            ...
            <label class="col-form-label col-lg-2"
                   for="country_code">{{__('pages/advertisers/create.content.inputs.country')}}</label>
            <div class="col-lg-10">
                <select x-model="country_code" x-cloak
                        data-placeholder="{{__('pages/advertisers/create.content.inputs.placeholders.country')}}"
                        id="country_code"
                        x-ref="country_code"
                ...
                <div class="form-group row" x-data="{city_id: @entangle('city_id').defer}"
                    ...
                    <div class="col-lg-10">
                        <select x-cloak x-model="city_id" name="city_id"
                                data-placeholder="{{__('pages/advertisers/create.content.inputs.placeholders.city')}}"
                                id="city_id"
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="language">{{__('pages/advertisers/create.content.inputs.language')}}</label>
            <div class="col-lg-10">
                <select class="form-control @error('language_code') is-invalid @enderror"
                        wire:model.defer="language_code"
                        id="language">
                    <option
                        value="none">{{__('pages/advertisers/create.content.inputs.placeholders.language')}}</option>
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="contact_number">{{__('pages/advertisers/create.content.inputs.contact_number')}}</label>
            <div class="col-lg-10">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="whatsapp_number">{{__('pages/advertisers/create.content.inputs.whatsapp_number')}}</label>
            <div class="col-lg-10">
                <input dir="ltr" class="form-control{{app()->getLocale() === 'ar' ? ' text-left' : ''}} @error('contact_number') is-invalid @enderror" id="whatsapp_number"
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="facebook_url">{{__('pages/advertisers/create.content.inputs.facebook_url')}}</label>
            <div class="col-lg-10">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="twitter_url">{{__('pages/advertisers/create.content.inputs.twitter_url')}}</label>
            <div class="col-lg-10">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="website_url">{{__('pages/advertisers/create.content.inputs.website_url')}}</label>
            <div class="col-lg-10">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <input type="number" class="form-control @error('allowed_posts_count') is-invalid @enderror"
                       id="allowed_posts_count"
                       wire:model.defer="allowed_posts_count">
                @error('allowed_posts_count')
                <div class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </div>
                @enderror
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="allowed_offers_count">{{__('pages/advertisers/create.content.inputs.allowed_offers_count')}}</label>
            <div class="col-lg-10">
                <input type="number" class="form-control @error('allowed_offers_count') is-invalid @enderror"
                       id="allowed_offers_count"
                       wire:model.defer="allowed_offers_count">
                @error('allowed_offers_count')
                <div class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </div>
                @enderror
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="maximum_monthly_offers">{{__('pages/advertisers/create.content.inputs.maximum_monthly_offers')}}</label>
            <div class="col-lg-10">
                <input type="number" class="form-control @error('maximum_monthly_offers') is-invalid @enderror"
                       id="maximum_monthly_offers"
                       wire:model.defer="maximum_monthly_offers">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10">
                <x-select wire:model.defer="status"
                          :options="[
                            'active' => __('pages/advertisers/create.content.inputs.status_options.active'),
                            'inactive' => __('pages/advertisers/create.content.inputs.status_options.inactive'),
                            'banned' => __('pages/advertisers/create.content.inputs.status_options.banned')
                            ]"
                          id="status"></x-select>
                @error('status')
                <div class="invalid-feedback" role="alert">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="is_elite">{{__('pages/advertisers/create.content.inputs.is_elite')}}</label>
            <div class="col-lg-10">
                <x-select wire:model.defer="is_elite"
                          :options="[1 => __('pages/advertisers/create.content.inputs.boolean.yes'), 0 => __('pages/advertisers/create.content.inputs.boolean.no')]"
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2"
                   for="is_accepted_send_notification">{{__('pages/advertisers/create.content.inputs.accepted_send_notification')}}</label>
            <div class="col-lg-10">
                <x-select wire:model.defer="is_accepted_send_notification"
                          :options="[1 => __('pages/advertisers/create.content.inputs.boolean.yes'), 0 => __('pages/advertisers/create.content.inputs.boolean.no')]"
                          id="is_accepted_send_notification"></x-select>
        ...
        <div class="text-right">
            <x-primary-button type="submit">
                {{__('pages/advertisers/create.content.submit')}}
            </x-primary-button>
        </div>
    </form>
</div>
...
@push('scripts')
    <script type="text/javascript">
        ...
        window.addEventListener('clearFileInput', () => {
            $('#image').val(null);
            $('#business_type').select2().val(null).change();
        ...
        window.addEventListener('select-governorate', (el) => {
            axios.get('{{route('admin.country.governorates')}}', {
                ...
                $('#governorate_id').select2({
                    placeholder: '{{__('pages/advertisers/create.content.inputs.placeholders.governorate')}}',
                    data: response.data,
                }).val('').change();

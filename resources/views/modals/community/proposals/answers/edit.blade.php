...
<x-form-modal wire:model="showEditModal" type="edit" wire="update({{$proposal['id'] ?? null}})">
    <x-slot name="title">
        {{__('pages/community/proposals/inquiry.modal.edit.title')}}
    </x-slot>
    <x-slot name="content">
        ...
        <div class="form-group">
            <label for="answer">{{__('pages/community/proposals/inquiry.modal.edit.inputs.answer')}}</label>
        ...
        <div class="form-group">
            <label for="media">{{__('pages/community/proposals/inquiry.modal.edit.inputs.images')}}</label>
    ...
    <x-slot name="footer">
        <x-secondary-button wire:click="closeEditModal" wire:loading.attr="disabled">
            {{__('pages/community/proposals/inquiry.modal.edit.cancel')}}
        </x-secondary-button>

        <x-primary-button wire:loading.attr="disabled" type="submit">
            {{__('pages/community/proposals/inquiry.modal.edit.submit')}}
        </x-primary-button>
    </x-slot>
</x-form-modal>
<!-- /Edit Items Confirmation Modal -->

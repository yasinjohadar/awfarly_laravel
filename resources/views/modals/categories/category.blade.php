...
<x-form-modal wire:model="showEditModal" type="edit" wire="update({{$category['id'] ?? null}})">
    ...
    <x-slot name="content">
        ...
        <div class="form-group"
            ...
            <label for="image">{{__('pages/categories/index.modal.edit.inputs.placeholders.choose_file')}}</label>
            <input type="file" wire:model.defer="category.new_image" class="form-control h-auto" id="image">
            <!-- Progress Bar -->
...
@push('scripts')
    <script type="text/javascript">
        ...
        window.addEventListener('refreshSelect2Edit', () => {
            $('#parent').select2({
        ...
        $('#parent').on('change', function (e) {
            ...
            window.livewire.emit('setParentCategoryEdit', item);
        });

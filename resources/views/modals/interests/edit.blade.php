...
<x-form-modal wire:model="showEditModal" type="edit" wire="update({{$interest['id'] ?? null}})">
    ...
    <x-slot name="content">
        ...
        <div class="form-group"
            ...
            <label for="new_image">{{__('pages/interests/index.modal.edit.inputs.image')}}</label>
            <input type="file" wire:model.defer="interest.new_image" class="form-control h-auto" id="new_image">
            <!-- Progress Bar -->

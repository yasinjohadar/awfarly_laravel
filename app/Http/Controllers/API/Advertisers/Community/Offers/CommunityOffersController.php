...
class CommunityOffersController extends Controller
{
    ...
    public function rateOffers($id, Request $request)
    {
        ...
        $existing_rating = Auth::guard('advertiser-api')->user()
            ->offersRated()
        ...
        return $this->apiResponse([
            'message' => $existing_rating
                ? __('api/advertisers/community/offers/offers.rating.updated-successfully')
                : __('api/advertisers/community/offers/offers.rating.rated-successfully'),
            'data' => [
                'rate' => $offer->rate,

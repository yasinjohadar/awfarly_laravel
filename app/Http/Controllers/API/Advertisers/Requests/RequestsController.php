...
namespace App\Http\Controllers\API\Advertisers\Requests;

use App\Helpers\Filter;
use App\Helpers\Settings;
use App\Http\Controllers\Controller;
use App\Http\Resources\Advertisers\Requests\UsernameRequestsResource;
...
class RequestsController extends Controller
{
    ...
    public function getUsernameChangeRequests(Request $request, $id = null)
    {
        ...
        //get requests
        $requests = Auth::guard('advertiser-api')->user()
            ->usernameRequests();
    ...
    public function changeUsername(Request $request)
    {
        ...
        if ($username_exists) {
            return $this->apiBadRequestResponse(__('api/advertisers/requests/requests.change-username.username-exists'));
        }
        ...
        if ($old_request) {
            ...
            if ($difference < $limit) {
                return $this->apiBadRequestResponse(__('api/advertisers/requests/requests.change-username.limit-exceeded', ['days' => $limit]));
            }
        }
        ...
        try {
            ...
            return $this->apiExceptionResponse(__('api/advertisers/requests/requests.something-wrong'));
        }
        DB::commit();
        return $this->apiResponse([
            'message' => __('api/advertisers/requests/requests.change-username.request-sent'),

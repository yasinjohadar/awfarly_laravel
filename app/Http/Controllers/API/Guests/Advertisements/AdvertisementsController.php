...
namespace App\Http\Controllers\API\Guests\Advertisements;

use App\Helpers\Geography\Geography;
use App\Helpers\Settings;
use App\Http\Controllers\Controller;
use App\Http\Resources\Guests\Advertisements\AdvertisementsResource;
...
class AdvertisementsController extends Controller
{
    ...
    public function getAdvertisements(Request $request)
    {
        ...
        $data = $request->only(array_merge(['type', 'categoryId', 'countryCode'], Geography::locationFilterFields()));

...
namespace App\Http\Controllers\API\Customers\Advertisements;

use App\Helpers\Geography\Geography;
use App\Helpers\Settings;
use App\Http\Controllers\Controller;
use App\Http\Resources\Customers\Advertisements\AdvertisementsResource;
    ...
    public function getAdvertisements(Request $request)
    {
        ...
        $advertisements = Advertisement::where(function ($query) {
            ...
            ->where(function ($query) {
                return $query->where('users', 'customers')
                    ->orWhere('users', 'any');
            })
        ...
        if (Geography::hasExplicitLocationFilter($data) || !empty($data['countryCode'])) {
            ...
            $prefs = Geography::preferredLocationIds(Auth::guard('customer-api')->user());

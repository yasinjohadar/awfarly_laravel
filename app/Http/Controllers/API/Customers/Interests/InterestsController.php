...
namespace App\Http\Controllers\API\Customers\Interests;

use App\Http\Controllers\Controller;
use App\Http\Resources\Interests\InterestsResource;
use App\Http\Resources\Users\Customers\Interests\CustomerInterestsResource;
...
class InterestsController extends Controller
{
    ...
    {
        $interests = Auth::guard('customer-api')->user()
            ->interests()
            ->pluck('interest_id')
            ->toArray();
    ...
    public function getInterestById($id)
    {
        ...
        if (!$interest) {
            return $this->apiBadRequestResponse(__('api/customers/interests/interests.wrong-id'));
        }
    ...
    public function deleteAdvertiserInterests(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            return $this->apiExceptionResponse(__('api/customers/interests/interests.something-wrong'));
        }

        DB::commit();
        return $this->apiResponse([
            'message' => __('api/customers/interests/interests.added'),
            'data' => CustomerInterestsResource::collection($interests),
        ]);

...
namespace App\Http\Controllers\Admins\Community\Comments;
...
class CommunityCommentsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.community.comments.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.pages.community.comments.index', ['filter_id' => $id]);
    }
    ...
    public function reportedComments()
    {
        ...
        return view('admin.pages.community.comments.reports.index');
    }
}

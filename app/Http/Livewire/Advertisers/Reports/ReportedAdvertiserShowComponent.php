...
class ReportedAdvertiserShowComponent extends LivewireDatatable
{
    use LivewireAlert;
    ...
    public $beforeTableSlot = 'modals.users.advertisers.reports.show';
    ...
    public function columns(): array
    {
        return [
            ...
            NumberColumn::name('reported_id')
                ->label(__('pages/advertisers/reports/show.content.datatable.advertiser_id'))
                ->filterable()
                ->searchable()
                ->hide(),
            Column::callback(['id', 'created_at'], function ($id) {
                ...
                ->label(__('pages/advertisers/reports/show.content.datatable.user_type'))
                ->searchable()
                ->unsortable(),
            NumberColumn::name('user_id')
                ->label(__('pages/advertisers/reports/show.content.datatable.user_id'))
                ->filterable()
                ->searchable()
                ->hide(),
            Column::callback(['id'], function ($id) {
                ...
                ->label(__('pages/advertisers/reports/show.content.datatable.user_name'))
                ->searchable(),
            Column::callback('type', function ($type) {
                return $type ? __("pages/advertisers/reports/show.content.datatable.types.{$type}") : '-';
            })
                ->label(__('pages/advertisers/reports/show.content.datatable.type'))
                ->filterable([
                    'Violence' => __("pages/advertisers/reports/show.content.datatable.types.Violence"),
                    'Sexually Inappropriate' => __("pages/advertisers/reports/show.content.datatable.types.Sexually Inappropriate"),
                    'Abusive Content' => __("pages/advertisers/reports/show.content.datatable.types.Abusive Content"),
                    'Misleading or Scam' => __("pages/advertisers/reports/show.content.datatable.types.Misleading or Scam"),
                    'Offensive' => __("pages/advertisers/reports/show.content.datatable.types.Offensive"),
                    'Prohibited Content' => __("pages/advertisers/reports/show.content.datatable.types.Prohibited Content"),
                    'Spam' => __("pages/advertisers/reports/show.content.datatable.types.Spam"),
                ])
                ->searchable(),
            Column::callback('reason', function ($reason) {
                return $reason ? Str::limit($reason, 30) : '-';
            })
                ->label(__('pages/advertisers/reports/show.content.datatable.reason'))
                ->filterable()
                ->searchable()
                ->hide(),
            ...
            Column::callback(['id', 'updated_at'], function ($id, $name) {
                return view('admin.pages.advertisers.reports.show-table-actions', ['id' => $id, 'name' => $name]);
            })
    ...
    {
        return Report::where('reported_type', AdvertiserUser::class)
    ...
    public function setModalTexts()
    {
        $this->showMoreModalTexts = [
            'title' => __('pages/advertisers/reports/show.modal.show.title'),
            'close' => __('pages/advertisers/reports/show.modal.show.close'),
        ];
    }
    ...
    public function showMoreModal($id)
    {
        ...
        //set log
        $this->log = [
            'advertiser_id' => $report->reported_id,
            'type' => $report->type,

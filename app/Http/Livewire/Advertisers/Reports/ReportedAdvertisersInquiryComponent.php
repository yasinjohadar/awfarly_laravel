...
class ReportedAdvertisersInquiryComponent extends LivewireDatatable
{
    use LivewireAlert;
    ...
    public function columns(): array
    {
        return [
            ...
            NumberColumn::name('reported_id')
                ->label(__('pages/advertisers/reports/reports.content.datatable.advertiser_id'))
                ->filterable()
                ->searchable()
    ...
    public function setModalTexts()
    {
        $this->deleteModalTexts = [
            'title' => __('pages/advertisers/reports/reports.modal.delete.title'),
            'content' => __('pages/advertisers/reports/reports.modal.delete.content'),
            'cancel' => __('pages/advertisers/reports/reports.modal.delete.cancel'),
            'submit' => __('pages/advertisers/reports/reports.modal.delete.submit'),
        ];
    }
}

...
class SliderAdvertisementsComponent extends Component
{
    ...
    {
        $this->all_advertisements_count = SliderAdvertisement::count();

        $this->active_advertisements_count = SliderAdvertisement::where('ends_at', '>', now())
            ->orWhereNull('ends_at')
            ->count();

        $this->expired_advertisements_count = SliderAdvertisement::where('ends_at', '<', now())
            ->count();

        return view('livewire.pages.advertisements.slider.index', [

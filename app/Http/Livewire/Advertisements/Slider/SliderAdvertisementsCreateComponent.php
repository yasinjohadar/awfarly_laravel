...
class SliderAdvertisementsCreateComponent extends Component
{
    use WithFileUploads;
    use LivewireAlert;
    ...
    public function render()
    {
        ...
        return view('livewire.pages.advertisements.slider.create');
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            $advertisement = SliderAdvertisement::create($data);

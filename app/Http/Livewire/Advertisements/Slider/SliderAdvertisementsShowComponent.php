...
class SliderAdvertisementsShowComponent extends Component
{
    use LivewireAlert;
    ...
    {
        //get advertisement
        $advertisement = SliderAdvertisement::where('id', $this->advertisement_id)
            ->first();
        ...
        return view('admin.pages.advertisements.slider.inquiry', [
    ...
    public function update($id)
    {
        ...
        $advertisement = SliderAdvertisement::where('id', $id)
            ->first();

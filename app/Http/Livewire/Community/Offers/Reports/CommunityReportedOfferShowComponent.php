        ...
        return [
            ...
            Column::callback('status', function ($status) {
                return $status === 'solved'
                    ? __('pages/community/offers/reports/show.content.solved')
                    : __('pages/community/offers/reports/show.content.unsolved');
            })
                ->label(__('pages/community/offers/reports/show.content.status'))
                ->filterable([
                    'pending' => __('pages/community/offers/reports/show.content.unsolved'),
                    'solved' => __('pages/community/offers/reports/show.content.solved'),
                ])
                ->searchable(),

...
class CommunityReportedOffersCommentInquiryComponent extends Component
{
    use LivewireAlert;
    ...
    public function setModalTexts()
    {
        $this->solveModalTexts = [
            'title' => __('pages/community/offers/comments/reports/show.modal.solve.title'),
            'content' => __('pages/community/offers/comments/reports/show.modal.solve.content'),
            'cancel' => __('pages/community/offers/comments/reports/show.modal.solve.cancel'),
            'submit' => __('pages/community/offers/comments/reports/show.modal.solve.submit'),
        ];

        $this->deleteModalTexts = [
            'title' => __('pages/community/offers/comments/reports/show.modal.delete.title'),
            'content' => __('pages/community/offers/comments/reports/show.modal.delete.content'),
            'cancel' => __('pages/community/offers/comments/reports/show.modal.delete.cancel'),
            'submit' => __('pages/community/offers/comments/reports/show.modal.delete.submit'),
        ];
    }
}

...
class CommunityReportedCommentShowComponent extends LivewireDatatable
{
    use LivewireAlert;
    ...
    public $beforeTableSlot = 'modals.community.comments.reports.show';
    ...
    public function columns(): array
    {
        return [
            ...
            NumberColumn::name('reported_id')
                ->label(__('pages/community/comments/reports/show.content.datatable.comment_id'))
                ->filterable()
                ->searchable()
                ->hide(),
            Column::callback(['id', 'created_at'], function ($id) {
                ...
                ->label(__('pages/community/comments/reports/show.content.datatable.user_type'))
                ->searchable()
                ->unsortable(),
            NumberColumn::name('user_id')
                ->label(__('pages/community/comments/reports/show.content.datatable.user_id'))
                ->filterable()
                ->searchable()
                ->hide(),
            Column::callback(['id'], function ($id) {
                ...
                ->label(__('pages/community/comments/reports/show.content.datatable.user_name'))
                ->searchable(),
            Column::callback('type', function ($type) {
                return $type ? __("pages/community/comments/reports/show.content.datatable.types.{$type}") : '-';
            })
                ->label(__('pages/community/comments/reports/show.content.datatable.type'))
                ->filterable([
                    'Violence' => __("pages/community/comments/reports/show.content.datatable.types.Violence"),
                    'Sexually Inappropriate' => __("pages/community/comments/reports/show.content.datatable.types.Sexually Inappropriate"),
                    'Abusive Content' => __("pages/community/comments/reports/show.content.datatable.types.Abusive Content"),
                    'Misleading or Scam' => __("pages/community/comments/reports/show.content.datatable.types.Misleading or Scam"),
                    'Offensive' => __("pages/community/comments/reports/show.content.datatable.types.Offensive"),
                    'Prohibited Content' => __("pages/community/comments/reports/show.content.datatable.types.Prohibited Content"),
                    'Spam' => __("pages/community/comments/reports/show.content.datatable.types.Spam"),
                ])
                ->searchable(),
            Column::callback('reason', function ($reason) {
                return $reason ? Str::limit($reason, 30) : '-';
            })
                ->label(__('pages/community/comments/reports/show.content.datatable.reason'))
                ->filterable()
                ->searchable()
                ->hide(),
            Column::callback('status', function ($status) {
                return $status === 'solved'
                    ? __('pages/community/comments/reports/show.content.solved')
                    : __('pages/community/comments/reports/show.content.unsolved');
            })
                ->label(__('pages/community/comments/reports/show.content.status'))
                ->filterable([
                    'pending' => __('pages/community/comments/reports/show.content.unsolved'),
                    'solved' => __('pages/community/comments/reports/show.content.solved'),
                ])
                ->searchable(),
    ...
    public function setModalTexts()
    {
        $this->showMoreModalTexts = [
            'title' => __('pages/community/comments/reports/show.modal.show.title'),
            'close' => __('pages/community/comments/reports/show.modal.show.close'),
        ];
    }

...
class CommunityReportedProposalsInquiryComponent extends LivewireDatatable
{
    ...
    public function columns(): array
    {
        return [
            ...
            NumberColumn::name('reported_id')
                ->label(__('pages/community/proposals/reports/reports.content.datatable.proposal_id'))
                ->filterable()
                ->searchable()
            ->linkTo('admin/community/proposals'),
            NumberColumn::callback(['id', 'user_type'], function ($id, $user_type) {
                return Report::findOrFail($id)
                    ->reports_count;
            })
                ->label(__('pages/community/proposals/reports/reports.content.datatable.reports_count'))
                ->searchable(),
            ...
            Column::callback(['reported_id'], function ($reported_id) {
                return view('admin.pages.community.proposals.reports.table-actions', ['reported_id' => $reported_id]);
            })
    ...
    public function setModalTexts()
    {
        $this->deleteModalTexts = [
            'title' => __('pages/community/proposals/reports/reports.modal.delete.title'),
            'content' => __('pages/community/proposals/reports/reports.modal.delete.content'),
            'cancel' => __('pages/community/proposals/reports/reports.modal.delete.cancel'),
            'submit' => __('pages/community/proposals/reports/reports.modal.delete.submit'),
        ];
    }
}

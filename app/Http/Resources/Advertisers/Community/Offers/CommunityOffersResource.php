...
namespace App\Http\Resources\Advertisers\Community\Offers;
...
class CommunityOffersResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        $isSelf = ($this->advertiser->id == Auth::guard('advertiser-api')->id() && $this->advertiser->user_type === 'advertiser');
        ...
        $false_permissions = !($this->advertiser->status === 'inactive' || Auth::guard('advertiser-api')->user()->status === 'inactive');
        ...
        return [
            ...
            'permissions' => [
                ...
                'isAllowRate' => $false_permissions && !$isSelf && !$is_expired,
                'isAllowShare' => true,
                'isAllowReport' => !$isSelf,
                'isAllowEdit' => $isSelf && !$is_expired,
